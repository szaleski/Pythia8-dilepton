...
# with command line options: step1 --filein file:EXO-RunIISummer16DR80Premix-06483.root --fileout file:EXO-RunIISummer16MiniAODv2-06326.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/EXO-RunIISummer16MiniAODv2-06326/EXO-RunIISummer16MiniAODv2-06326_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1920
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:MC16AODout.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:MC16miniAODout.root'),
